...
const TeamBuilder = () => {
    return (
        <Layout>
            ...
            <div className="flex items-center justify-center bg-fixed bg-center bg-no-repeat bg-cover bg-watatsumi -z-1 py-16 px-10  w-full min-h-screen">
                <div  className='p-4 flex flex-col bg-menu-gray border-white border-opacity-50 border-4 rounded-lg w-full lg:w-1/2'>
